...
export function MarkdownRenderer({ children }: MarkdownRendererProperties) {
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        code({ node, inline, className, children, ...properties }) {
          ...
          return (
            <code
              className={cn(
                "rounded-sm bg-neutral-100 px-1 py-0.5 font-mono text-neutral-800 dark:bg-neutral-800 dark:text-neutral-200",
                className,
              )}
              {...properties}
            >
